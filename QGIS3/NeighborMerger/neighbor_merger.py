...
/***************************************************************************
 NeighborMerger
                                 A QGIS plugin
 This plugin merges selected neighboring polygon entities.
...
class NeighborMerger:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/neighbor_merger/icon.png'
        self.add_action(
            icon_path,
    ...
    def merge_selected_features(self, layer):
        ...
        if len(selected) < 2:
            self.display_error(
                'Le nombre d\'entités sélectionnées est insuffisant.')
            return
        ...
        if not valid:
            ...
            layer.rollBack()
            self.display_error('Erreur dans la saisie des attributs.')
            return
        ...
        if not valid:
            ...
            layer.rollBack()
            self.display_error(
                'Erreur lors de l\'ajout de la nouvelle entité.')
            return
